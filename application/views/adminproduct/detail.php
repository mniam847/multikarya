                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group row">
                                        <label for="4" class="col-lg-1  col-form-label">Gambar Product
                                            <img style="hight:50px;width:50px;" src="<?= base_url(); ?>uploads/<?= $product[0]['picture']; ?>" alt="">
                                        </label>
                                        <div class="col-sm-5">
                                            <input type="file" value="<?= $product[0]['picture']; ?>" class="form-control" id="3" name="picture" placeholder="Masukkan gambar" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
