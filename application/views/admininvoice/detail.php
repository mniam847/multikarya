            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form action="<?= base_url('admin/updateInvoice'); ?>" method="post">
                                    <div class="row">
                                        <div class="col-8">
                                    ...
                                    <a href="<?= base_url('admin/showInvoice'); ?>" class="btn btn-info">Batal</a>
                                    <a href="<?= base_url('admin/deleteInvoice'); ?>" class="btn btn-danger">delete</a>
