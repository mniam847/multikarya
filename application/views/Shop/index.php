                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="<?= base_url("assets/shop/img/promosi.jpg") ?>" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Limited SLot</h3>
                                    <a href="<?= base_url()?>product" class="btn btn-light py-2 px-3">Shop Now</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=<?= $cs; ?>&text=Halo,%20saya%20ingin melakukan%20pesanan%20untuk%20barang%20<?= $product['name'] ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Order via WA</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
